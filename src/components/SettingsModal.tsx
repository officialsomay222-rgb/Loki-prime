          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                className="flex-1 overflow-y-auto p-4 sm:p-6 custom-scrollbar min-h-0 overscroll-contain transform-gpu"
                style={{
                ...
                >
                  <div className="relative">
                    <motion.div 
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-20 h-20 rounded-full overflow-hidden border-2 border-slate-200 dark:border-white/10 shadow-2xl cursor-pointer group relative aspect-square focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:outline-none"
                  ...
                  <div className="text-center space-y-0.5">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">{commanderName || 'Owner'}</h3>
                    <p className="text-xs text-slate-500 dark:text-[#717171] font-medium">{commanderEmail}</p>
                  </div>
                  ...
                  <motion.button 
                    ...
                    className="px-8 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full text-xs font-bold transition-all shadow-md focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:outline-none"
                  >
                    Edit Profile
                  </motion.button>
                </motion.div>
