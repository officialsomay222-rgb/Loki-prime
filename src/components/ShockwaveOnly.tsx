...
const fragmentShaderSource = `
  ...
  void main() {
    ...
    // Render central animated infinity loop removed for ShockwaveOnly component
...
export const ShockwaveOnly = forwardRef<WebGLCanvasRef, { config?: ShockwaveConfig }>(({ config }, ref) => {
...
ShockwaveOnly.displayName = 'WebGLShockwave';
