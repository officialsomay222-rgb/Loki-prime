...
const regex1 = /for await \\(const chunk of responseStream\\) {\\n\\s*if \\(chunk\\.text\\) {\\n\\s*res\\.write\\(\`data: \\$\\{JSON\\.stringify\\(\\{ text: chunk\\.text \\}\\)\\}\\n\\n\`\\);\\n\\s*}/g;

const replacement = `for await (const chunk of responseStream) {
